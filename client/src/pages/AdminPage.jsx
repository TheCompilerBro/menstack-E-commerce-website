  ...
  if (!auth) {
    return (
      <main className="form-wrap">
        ...
        <p>Please login first to access the admin dashboard.</p>
        <p><Link to="/login?redirect=/admin-dashboard">Go to login</Link></p>
      </main>
    );
  }
  ...
  if (!auth.isAdmin) {
    return (
      <main className="form-wrap">
        ...
        <p><Link to="/login?redirect=/admin-dashboard">Switch account</Link></p>
      </main>
    );
  }
