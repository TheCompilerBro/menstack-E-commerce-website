...
- **`/admin-dashboard` shows login/access message**: make sure you are logged in as admin (`admin@store.com` / `admin123`). If you logged in before admin roles were added, log out and log in again so the profile role refreshes.
